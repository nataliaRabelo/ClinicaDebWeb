    ...
    <body>
        <div class="container">
            <div class="col-sm-6 offset-3 mt-5">
                <div align="center"><font face="Trebuchet MS" color="#FFFAFA"><h1>Editar convênio</h1></font></div>
                    <form action="EditarConvenio" method="POST">
                     <input type="hidden" name="id" value="<%=request.getAttribute("id")%>"/>
                     <div class="mb-3">
                        <label for="descricao" class="form-label" color="#FFFAFA" value="<%=tipoPlano.getDescricao()%>">descricao</label>

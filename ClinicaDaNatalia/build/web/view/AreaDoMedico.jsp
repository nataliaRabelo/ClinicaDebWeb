...
<html lang="pt-br">
    <head>
        ...
        <div align="center"><font face="Trebuchet MS" color="#FFFAFA"><h1 class="display-1">Bem-vindo, médico. O que deseja fazer?</h1></font></div>
        <div align="center" class="span3">
              <a href="/ClinicaDaNatalia/RealizarConsulta"><button style="background: #FFFAFA; border-radius: 6px; padding: 15px; cursor: pointer; color: #008AAF; border: none; font-size: 16px;">Realizar consulta</button></a>
